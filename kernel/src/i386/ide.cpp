...
class IdeStorage : public Storage {
public:
  ...
  future<DiskBlock*> readBlock(size_t sector, size_t count) override;
...
future<DiskBlock*> IdeStorage::readBlock(size_t sector, size_t count) {
  ...
  return make_ready_future<DiskBlock*>(db);
}
